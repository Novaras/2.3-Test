...
base_research = {
	...
	{ 
		...
		DisplayedName =		"$7732",
		DisplayPriority =	281,
		Description =		"<b>Description:</b> Allows Scouts to fire a EMP attack that can overload and stun enemy ships for a limited time. \n\nSeveral EMP detonations must land simultaneously to overwhelm the target. \n\n<b>Prerequisites:</b> Research Module and Fighter Facility.",
		UpgradeType =		Ability,
		TargetType =		Ship,
