...
base_research = {
 ...
 
	{
		...
		DisplayedName =			"$7519",
		DisplayPriority =		31,
		Description =			"<b>Description:</b> Allows Scouts to fire a EMP attack that can overload and stun enemy ships for a limited time. Several EMP detonations must land simultaneously. \n\n<b>Prerequisites:</b> Research Module.",
		UpgradeType =			Ability,
		TargetType =			Ship,
		TargetName =			"Hgn_Scout",
